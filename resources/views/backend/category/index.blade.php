          ...
          <tbody>
            ...
            @foreach($categories as $category)
                ...
                <tr>
                    ...
                    <td>
                        @if($category->icon_file_name)
                            <img src="{{$category->icon->url()}}" class="img-fluid" style="max-width:80px" alt="{{$category->photo}}">
                        @else
                    ...
                    <td>
                        @if($category->banner_file_name)
                            <img src="{{$category->banner->url()}}" class="img-fluid" style="max-width:80px" alt="{{$category->photo}}">
                        @else
                            <img src="{{asset('backend/img/thumbnail-default.jpg')}}" class="img-fluid" style="max-width:80px" alt="avatar.png">
                        @endif
                    </td>
